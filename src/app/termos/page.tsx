        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 32 }}>
          <section>
            ...
            <p style={{ color: 'var(--text-secondary)', lineHeight: 1.7 }}>
              Ao acessar ou usar o Vimens, você concorda em cumprir estes Termos de Uso. 
          ...
          <section>
            ...
            <p style={{ color: 'var(--text-secondary)', lineHeight: 1.7 }}>
              O Vimens é uma plataforma de estudo baseada em flashcards com repetição espaçada. 
              O serviço permite que usuários criem, importem e estudem flashcards, utilizando 
              algoritmos de aprendizado para otimizar a memorização.
            </p>
          </section>
          ...
          <section>
            ...
            <p style={{ color: 'var(--text-secondary)', lineHeight: 1.7 }}>
              ...
              e por todas as atividades que ocorram em sua conta. Notifique-nos imediatamente 
          ...
          <section>
            ...
            <p style={{ color: 'var(--text-secondary)', lineHeight: 1.7 }}>
              Você mantém os direitos sobre o conteúdo que cria no Vimens. Ao usar o serviço, 
          ...
          <section>
            ...
            <p style={{ color: 'var(--text-secondary)', lineHeight: 1.7 }}>
              Oferecemos planos gratuitos e pagos. Os planos pagos são cobrados mensalmente. 
              Você pode cancelar a qualquer momento. O período de teste gratuito de 7 dias 
              do plano Premium não requer cartão de crédito antecipado.
            </p>
          </section>
          ...
          <section>
            ...
            <p style={{ color: 'var(--text-secondary)', lineHeight: 1.7 }}>
              O Vimens é fornecido "como está". Não garantimos que o serviço será ininterrupto 
              ou livre de erros. Não nos responsabilizamos por danos indiretos resultantes 
          ...
          <section>
            ...
            <p style={{ color: 'var(--text-secondary)', lineHeight: 1.7 }}>
              ...
              significativas por email ou através do serviço. O uso continuado após alterações 
